...
<div class="mask" style="display:none"></div>
	...
	<div class="lyr lyrpop01" style="display:none">
		<div class="lyr_inner">
		   <p><strong>1. 개인정보 수집 항목 (필수)</strong><br>
										성명, 전화번호</p><br>
			<p><strong>2. 이용목적</strong><br>
			  다윈소프트 설명회 참석</p><br>
			<p><strong>3. 보유기간</strong><br>
			  설명회 참석에 대한 이용 목적이 달성된 후에는 해당 정보를 지체없이 파기</p><br><br>								
...
<form id="frmdata" name="frmdata" method="post" action="/Brokerspresentation/saveresult">
	<input type="text" id="bname" name="bname" value="">
	<input type="text" id="phone" name="phone" value="">
	<button id="savedata" name="savedata">전송</button>
</form>
