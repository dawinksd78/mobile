        ...
        <div class="sub_container subloc">
            <div class="cont_wrap">
                ...
                <!-- 상단 중개사무소 위치포인터 클릭했을 떄 view -->
              	<div class="agent_lst mbot_area" id="agent_lst" style="z-index:10000; display:none;"></div>
            </div>
...
var searchitems = Object.keys(realtorcnt.data).length;

var selectOfficeNumbers = [<?php echo $selbrokers; ?>];
