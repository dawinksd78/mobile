                ...
                <div class="cont" id="signforms">
                    <div class="inpbox rdinp">
                        ...
                        <div class="dtinp" style="display:<?php echo ( !isset($step2['ENTER_TYPE']) ||  $step2['ENTER_TYPE']!='3') ? "none":""?>">
                            <input type="date" id="today" name="ENTER_DATE" value="<?php echo $step2['ENTER_DATE']; ?>" placeholder="날짜지정" title="날짜지정" class="inp" autocomplete="off">
                            <span class="unit">이후</span>
                        </div>
                    </div>
                    
                    <?php /* 아파트 & 오피스텔 설정 */ if($step2['CATEGORY'] != 'ONE') { ?>
                    <div class="inpbox">
                    ...
                    <?php /* 아파트 & 오피스텔 설정 */ if($step2['CATEGORY'] == 'APT' || $step2['CATEGORY'] == 'OFT') { ?>
                        <!-- div class="inpbox rdinp">
                        ...
                        <?php if($step2['TRADE_TYPE']==2 || $step2['TRADE_TYPE']==3) { ?>
                        <div class="inpbox rdinp">
                    ...
                    <?php /* 원룸 */ } else if($step2['CATEGORY'] == 'ONE') { ?>
                        <div class="inpbox">
                    ...
                    <div class="inpbox">
                        ...
                        <textarea class="txtarea" name="OWNER_COMMENT" placeholder="빠른 거래를 위해 장점 위주로 간략하게 설명해주세요. &#13;&#10;ex) ex) 1년전 인테리어 공사로 깨끗하고 고층이라 조망권이 좋습니다. 단지내 어린이집이 있어 아이 키우기 너무 좋아요 등"><?php echo (isset($step2['OWNER_COMMENT'])) ? $step2['OWNER_COMMENT']:"" ?></textarea>
                    </div>
                </div>
