...
class Goods_model extends CI_Model
{
    ...
    public function goodsViewinfoAPT($goods_idx, $MBR_IDX=false)
    {
        ...
        $sql = "SELECT
                    ...
                    (SELECT GROUP_CONCAT(concat(SERVER_PATH, FULL_PATH)) FROM TB_UM_GOODS_IMG WHERE GOODS_IDX = goods.GOODS_IDX AND FILE_SEPARATE='OUT' order by FILE_SEPARATE, GOODS_IMG_IDX) AS images, 
